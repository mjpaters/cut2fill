...
const registeredFacilities = [
    ...
    // Toowoomba
    { name: 'Boral — Wellcamp Quarry', type: 'quarry', lat: -27.5600, lng: 151.7900, suburb: 'Wellcamp', icon: 'fa-gem', color: '#8a8478', hours: 'business', notes: '1511 Toowoomba Cecil Plains Rd, Wellcamp. Formerly Wagners — acquired by Boral. Concrete, sealing, asphalt and drainage aggregates, road base, pavement materials.' },
